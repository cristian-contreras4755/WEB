   ...
   public interface IIncidenciaRepository
    {
        ...
        /*
        Task<CommonResult<IncidenciaListModel>> Incidencia_Pendiente_Cons(int IdEstIncidencia);
        Task<CommonResult<IncidenciaListModel>> Incidencia_Asignados_Cons(int IdEstIncidencia);
        Task<CommonResult<IncidenciaListModel>> Incidencia_Encurso_Cons(int IdEstIncidencia);
        Task<CommonResult<IncidenciaListModel>> Incidencia_Desestimado_Cons(int IdEstIncidencia);
        Task<CommonResult<IncidenciaListModel>> Incidencia_Cerrado_Cons(int IdEstIncidencia);

    */
        #endregion

        #region Incidencia API
        Task<CommonResult<Incidencia>> Incidencia_Crea_Service(Incidencia incidenciaModel);
        #endregion
